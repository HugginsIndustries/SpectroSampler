...
class WaveformWidget(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self._theme_colors: dict[str, QColor] = {
            ...
            "waveform_fill": QColor(0x5C, 0xAF, 0xF2, 0x7F),
            "waveform_outline": QColor(0x5C, 0xAF, 0xF2),
            "axis": QColor(0x33, 0x33, 0x33),
            "segment_enabled": QColor(0x00, 0x78, 0xD4, 0x40),
            "segment_selected": QColor(0x00, 0x78, 0xD4, 0x90),
